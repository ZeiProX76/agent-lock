...
- **The Windows code paths are unit-tested, not yet run on Windows.** The suite runs on macOS and Linux here; CI covers ubuntu, macOS and Windows on Node 18, 20 and 22.
